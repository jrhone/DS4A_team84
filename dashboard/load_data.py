...
def data_prep_total_enrollment():
    ...
    df = pd.read_csv('~/team_84/organized notebooks/dashboard_total_enrollment.csv', index_col = 0)
...
def data_prep_assessment():
    return pd.read_csv('~/team_84/organized notebooks/dashboard_assessment.csv', index_col=0)

def data_prep_final_merged():
    df = pd.read_csv('~/team_84/organized notebooks/dashboard_final_merged.csv')
...
def data_prep_by_school():
    return pd.read_csv('~/team_84/organized notebooks/dashboard_school_df.csv', index_col=0)